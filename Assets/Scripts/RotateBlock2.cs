...
public class RotateBlock2 : MonoBehaviour
{
    ...
    void Update()
    {
        if (my_rotate)
        {
            ...
            all_roads1.transform.localRotation = Quaternion.Euler(0, roty, 0);
            all_blocks1.transform.localRotation = Quaternion.Euler(0, roty, 0);
            ...
            if (roty > 358.0f)
            {
                ...
                all_roads1.transform.localRotation = Quaternion.Euler(0, 0, 0);
                all_blocks1.transform.localRotation = Quaternion.Euler(0, 0, 0);
                all_roads2.transform.localRotation = Quaternion.Euler(0, 0, 0);
                all_blocks2.transform.localRotation = Quaternion.Euler(0, 0, 0);
                my_car.transform.localRotation = Quaternion.Euler(0, 180.0f, 0);
    ...
    void OnCollisionEnter(Collision col)
    {
        ...
        if (col.gameObject.name == "Car3" && !GlobalVars.rotate_now)
        {
            ...
            road_set1 = GameObject.Find("/ImageTarget - Roads/AllRoads2/RoadSet1");
            road_set2 = GameObject.Find("/ImageTarget - Roads/AllRoads2/RoadSet2");
            block1 = GameObject.Find("/ImageTarget - Blocks/AllBlocks2/Block1");
            block2 = GameObject.Find("/ImageTarget - Blocks/AllBlocks2/Block2");

            road_set1.transform.position = road_set2.transform.position;
            block1.transform.position = block2.transform.position;
            road_set1.transform.localPosition += new Vector3(-4, 0, 4);
            block1.transform.localPosition += new Vector3(-4, 0, 4);
            all_roads1.transform.localPosition = new Vector3(0, 0, 0);
            all_blocks1.transform.localPosition = new Vector3(0.689f, 0, 0);
            ...
            switch (this.gameObject.name)
            {
                case "NE2":
                    road_set1.transform.localPosition += new Vector3(4, 0, -4);
                    block1.transform.localPosition += new Vector3(4, 0, -4);
                    all_roads1.transform.localPosition += new Vector3(-2, 0, 2);
                    all_blocks1.transform.localPosition += new Vector3(-2, 0, 2);
                    break;
                case "NW2":
                    road_set1.transform.localPosition += new Vector3(4, 0, 4);
                    block1.transform.localPosition += new Vector3(4, 0, 4);
            ...
            road_set1.transform.parent = all_roads1.transform;
            road_set2.transform.parent = all_roads1.transform;
            block1.transform.parent = all_blocks1.transform;
            block2.transform.parent = all_blocks1.transform;
            ...
            //}
            pylon_parent1 = GameObject.Find("ImageTarget - Roads/AllRoads1/RoadSet1/Pylons1");
            pylon_parent2 = GameObject.Find("ImageTarget - Roads/AllRoads1/RoadSet2/Pylons2");
            sensor_parent1 = GameObject.Find("ImageTarget - Roads/AllRoads1/RoadSet1/Sensors1");
            sensor_parent2 = GameObject.Find("ImageTarget - Roads/AllRoads1/RoadSet2/Sensors2");
            sensor_parentb1 = GameObject.Find("ImageTarget - Blocks/AllBlocks1/Block1/Sensorsb1");
            sensor_parentb2 = GameObject.Find("ImageTarget - Blocks/AllBlocks1/Block2/Sensorsb2");
